 ...
 * humano haya confirmado la licencia de reutilización y haya descargado el
 * asset a `public/products/`. Ver la nota de `productMediaSchema` sobre por
 * qué `approved` exige `localPath` (autoalojado) y no un `imageUrl` remoto.
 */
